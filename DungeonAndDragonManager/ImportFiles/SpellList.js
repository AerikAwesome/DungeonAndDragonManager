...
var Base_spellLevelList = ["cantrip", "1st-level", "2nd-level", "3rd-level", "4th-level", "5th-level", "6th-level", "7th-level", "8th-level", "9th-level","Psionic Talents","Psionic Disciplines"];
...
var Base_SpellsList = {
	...
	"charm person" : {
		...
		duration : "1 h",
		save : "Wis",
		description : "1+1/SL humanoids in 15-ft rad save or charmed; crea adv. on save if you or your allies are fighting it",
	...
	"command" : {
		...
		duration : "1 rnd",
		save : "Wis",
		description : "1+1/SL crea in 15-ft rad save or follow one word command, such as approach, drop, flee, grovel, halt",
	...
	"darkness" : {
		...
		duration : "Conc, 10 min",
		description : "15-ft rad darkness on point or object; darkvision doesn't work; only magical light of higher SL works",
	...
	"daylight" : {
		...
		components : "V,S",
		duration : "1 h",
		description : "60-ft rad bright light + 60-ft dim light on point or object; only magical darkness of higher SL works",
	...
	"detect thoughts" : {
		...
		duration : "Conc, 1 min",
		save : "Wis",
		description : "1 a read thougths of visible Int>3 crea or detect presence of invisible within 30 ft; save for probing",
	...
	"dispel magic" : {
		...
		descriptionFull : "Choose any creature, object, or magical effect within range. Any spell of 3rd level or lower on the target ends. For each spell of or higher on the target, make an ability check using your spellcasting ability. The DC equals 10 + the spell's level. On a successful check, the spell ends." + AtHigherLevels + "When you cast this spell using a spell slot of 4th level or higher, you automatically end the effects of a spell on the target if the spell's level is equal to or less than the level of the spell slot you used."
	},
	"divination" : {
		name : "Divination",
		classes : ["cleric"],
	...
	"fear" : {
		...
		duration : "Conc, 1 min",
		save : "Wis",
		description : "All crea save or drop what it is holding and frightened; extra save/rnd if crea is not in line of sight",
	...
	"hold monster" : {
		...
		duration : "Conc, 1 min",
		save : "Wis",
		description : "1+1/SL crea within 30 ft of each other save or paralyzed; extra save at end of each turn",
	...
	"hold person" : {
		...
		duration : "Conc, 1 min",
		save : "Wis",
		description : "1+1/SL humanoid within 30 ft of each other save or paralyzed; extra save at end of each turn",
	...
	"polymorph" : {
		...
		descriptionFull : "This spell transforms a creature with at least 1 hit point that you can see within range into a new form. An unwilling creature must make a Wisdom saving throw to avoid the effect. A shapechanger automatically succeeds on this saving throw." + "\n   " + "The transformation lasts for the duration, or until the target drops to 0 hit points or dies. The new form can be any beast whose challenge rating is equal to or less than the target's (or the target's level, if it doesn't have a challenge rating). The target's game statistics, including mental ability scores, are replaced by the statistics of the chosen beast. It retains its alignment and personality." + "\n   " + "The target assumes the hit points of its new form. When it reverts to its normal form, the creature returns to the number of hit points it had before it transformed. If it reverts as a result of dropping to 0 hit points, any excess damage carries over to its normal form. As long as the excess damage doesn't reduce the creature's normal form to 0 hit points, it isn't knocked unconscious." + "\n   " + "The creature is limited in the actions it can perform by the nature of its new form, and it can't speak, cast spells, or take any other action that requires hands or speech." + "\n   " + "The target's gear melds into the new form. The creature can't activate, use, wield, or otherwise benefit from any of its equipment."
	},
	"power word kill" : {
	...
	"simulacrum" : {
		...
		range : "Touch",
		components : "V,S,M\u2020",
		compMaterial : "Snow or ice in quantities sufficient to made a life-size copy of the duplicated creature; and powdered ruby worth 1,500 gp, sprinkled over the duplicate and consumed by the spell",
		duration : "Till dispelled",
	...
	"storm of vengeance" : {
		...
		duration : "Conc, 1 min",
		save : "Con",
		description : "360-ft rad all save or 2d6 Thunder dmg and deafened for 5 min; intensifies every rnd; see book",
	...
	"suggestion" : {
		...
		range : "30 ft",
		components : "V,M",
		compMaterial : "A snake's tougne and either a bit of honeycomb or a drop of sweet oil",
		duration : "Conc, 8 h",
		save : "Wis",
